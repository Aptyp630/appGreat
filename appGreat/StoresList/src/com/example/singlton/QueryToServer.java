...
public class QueryToServer {
    ...
    public OnResponseListener requestQueue(final OnResponseListener showProductListener, Context context){
        ...
        RequestQueue requestQueue = Volley.newRequestQueue(context);
            JsonObjectRequest jsonObjectRequest = new JsonObjectRequest(Request.Method.GET, url, null, new Response.Listener<JSONObject>() {
                ...
                public void onResponse(JSONObject jsonObject) {
                    ...
                    List<Product> productList = parseJsonArray(jsonObject);
                    showProductListener.onProductsReceived(productList);
                    }
    ...
    //РАСПАРСИЛ МАССИВ
    public List<Product> parseJsonArray(JSONObject jsonObject){
